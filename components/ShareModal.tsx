    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="shad-dialog">
        ...
        <div className="my-2 space-y-2">
          ...
          {Object.entries(collaborators[0])
  .filter(([key, value]) => key !== 'userType') // Exclude 'userType'
  .map(([key, collaborator]) => (
    <Collaborator
      key={collaborator.id} // Make sure `id` is unique for each collaborator
      roomId={roomId}
      creatorId={creatorId}
